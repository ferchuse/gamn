<?php 
	include ("main.php");
	$consulta_propietarios = "SELECT a.cve,a.nombre FROM propietarios AS a";
	...
	$res=mysql_db_query($base,$consulta_propietarios) or die(mysql_error());
	
	
	while($row=mysql_fetch_array($res)){
		$array_propietario[$row['cve']]=$row['nombre'];
	}
	// print_r("<pre> array_propietario");
	// print_r($array_propietario);
	// print_r("<pre>");
	
	
	// ($array_propietario);
	
	$consulta_propietarios_operadores = " SELECT * FROM ".$pre."propietarios_operadores WHERE 1 group by cve_propietario ORDER BY cve_propietario";
	$res=mysql_db_query($base, $consulta_propietarios_operadores);
	while($row=mysql_fetch_array($res)){
		// echo $row['cve_propietario']. "<br>";
		$array_propietario_opera[$row['cve_propietario']]=$array_propietario[$row['cve_propietario']];
	}
	
	
	// print_r("<pre> array_propietario_opera");
	// print_r($consulta_propietarios_operadores);
	// print_r("<pre>");
	...
	if($_POST['ajax']==1) {
		...
		if(mysql_num_rows($res)>0) 
		{
			...
			while($row=mysql_fetch_array($res)) {
				...
				echo '<td>'.($array_propietario[$row['cve_propietario']]).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
